...
public class DemoGuruTest {
    ...
    public void test01() {
        ...
        actions.dragAndDrop(guru99Page.bankButonuElementi, guru99Page.debitAccountElementi);
        // CREDIT SIDE da Account bolumune SALES butonunu surukle ve birak
        actions.dragAndDrop(guru99Page.salesButonu, guru99Page.creditAccountElementi);
        // DEBIT SIDE da Amount bolumune 5000 butonunu surukle ve birak
        actions.dragAndDrop(guru99Page.birinciBesBinButonuElementi, guru99Page.debitAmountElementi);
